...
public class UserController {
    ...
    public BaseResponse<UserVO> updateUserVoucher(@RequestBody(required = false) UserUpdateRequest userUpdateRequest, HttpServletRequest request) {
//        if (userUpdateRequest == null || userUpdateRequest.getId() == null) {
//            throw new BusinessException(ErrorCode.PARAMS_ERROR);
//        }
        UserVO userVo  = userService.updateUserVoucher(userUpdateRequest, request);
        return ResultUtils.success(userVo);
    }
